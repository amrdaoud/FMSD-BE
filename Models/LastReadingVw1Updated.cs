...
public partial class LastReadingVw1Updated
{
    ...
    public DateTime? UpdatedAtminus30 { get; set; }

    public long? RowNumber { get; set; }

    public double? AvgConsumption { get; set; }

    public string? TanksDate { get; set; }

    public string TankNameNoUse { get; set; } = null!;

    public double? DaysCoverd { get; set; }
}
